...
| [UC-03](uc-03-compensating-control.md) | Compensating-control worksheet — Meridian QSA-Support (solo consultant, 30-location franchise on SAQ D) | retail-ecommerce, financial-services | Assessor support (solo consultant) | Legacy POS that cannot meet a Req-8 control → **compensating control** (not customized approach); all six Appendix-C worksheet rows present → **worksheet complete** |
