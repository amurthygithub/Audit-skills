...
- **Remote-first changes the physical story, not the obligation.** §164.310(b)–(c) workstation standards follow the laptop into the home office; the facility specs get honest `not_reasonable_documented` dispositions (UC-01 §3).
