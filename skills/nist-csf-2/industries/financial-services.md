...
| GV.SC (Supply Chain Risk) | Risk Management Program (third-party extension) | GV.SC extends the OCC risk management program expectation to third-party and supply-chain cyber risk. | NIST-CSF-2.0 Section 2.2; Interagency Guidance on Third-Party Relationships (OCC Bulletin 2023-17 — confirm the bulletin number at occ.gov before citing) |
...
Note: This table is representative, not exhaustive. DFS Part 500 is a prescriptive regulation; CSF 2.0 is an outcome-based framework. Some DFS requirements (e.g., Section 500.17(a) 72-hour notification) are specific regulatory mandates with no exact CSF 2.0 match. No authoritative crosswalk from CSF 2.0 to NY DFS Part 500 has been published by DFS or NIST; mappings are interpretive. (Confirm exact section numbers of the amended November 2023 version against the current 23 NYCRR 500 text before quoting.)
...
- "The OCC Heightened Standards are codified in 12 CFR 30 Appendix D (effective September 2014). OCC Bulletin 2014-13 is an UNRELATED FFIEC joint statement on ATM/card-authorization attacks — do not cite it as the Heightened Standards. Cite 12 CFR 30 App. D directly (or the Federal Register final rule)."

- "FFIEC CAT facts verified 2026-06-10 against the CAT May 2017 PDF and the FFIEC sunset statement: the 5 domains are Cyber Risk Management and Oversight; Threat Intelligence and Collaboration; Cybersecurity Controls; External Dependency Management; Cyber Incident Management and Resilience. The maturity levels are Baseline/Evolving/Intermediate/Advanced/Innovative. There was never a 'CAT 2.0' — the FFIEC announced in Aug 2024 that it would NOT update the CAT and sunset it effective Aug 31, 2025."

- "Table 3 (CSF 2.0 Subcategory to NY DFS 500) is a representative interpretive mapping — no authoritative CSF-to-DFS crosswalk has been published by DFS or NIST. Have qualified counsel review each mapping before presenting it to a DFS examiner, and confirm section numbers against the current amended (November 2023) 23 NYCRR 500 text (the notification provision moved across amendments)."

- "The 2023 Interagency Guidance on Third-Party Relationships is commonly cited as OCC Bulletin 2023-17 — confirm the bulletin number at occ.gov (or use the Federal Register citation) before quoting it in a deliverable."
