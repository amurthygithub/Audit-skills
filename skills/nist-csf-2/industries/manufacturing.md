...
CMMC L2 requires the 110 controls of NIST 800-171 Rev 2 (per 32 CFR 170.14(c)(3)). For a small machine shop (50-200 employees, $10M-$50M annual revenue) that wants to bid on DoD work, the compliance cost is estimated at $50,000-$150,000 for the assessment alone (practitioner estimate — verify against current DoD CMMC cost documentation before budgeting), plus implementation costs (MFA, SIEM, encryption, policy development) that can reach $250,000-$750,000. For a small manufacturer with 5% net margin on $30M revenue ($1.5M profit), a $500,000 compliance program is one-third of annual profit.
