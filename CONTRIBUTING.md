...
2. **Design (G2).** Copy [`docs/skill-design-template.md`](docs/skill-design-template.md) to `docs/<your-skill-slug>-design.md` and fill in all sections. Gate: `python tools/check_design_doc.py docs/<slug>-design.md` must pass. Read [`docs/csf-2-design.md`](docs/csf-2-design.md) for a fully-filled example (1,391 lines) and use [`skills/nist-800-53-rmf/`](skills/nist-800-53-rmf/) as the load-bearing reference architecture.
