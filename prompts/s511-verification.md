...
15. **House-convention attribution** — every formula, scale, weighting, threshold, or rollup must either carry a verbatim source quote or be explicitly labeled a house convention/illustrative heuristic. Invented math attributed to a named publication is CRITICAL (e.g., "L×I×CRF per the CISA CRM", "%-gap per NIST").
