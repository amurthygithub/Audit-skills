...
| 3 | **sox-302-disclosure-controls** (SOX-570) ✅ SHIPPED 2026-06-11 (PR #67) — born-vetted; public SEC sources, fully machine-verifiable. §5.11 CLEAN (zero findings vs live eCFR/statute). The DC&P≠ICFR + §302≠§404 boundaries are the spine. | SOX-640 (workpapers: company-side content, ITGC sampling, GAGAS formats) — pending |
