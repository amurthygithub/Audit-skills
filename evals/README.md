...
| 5 | 2026-06-11 | haiku-4.5 | sox-302 4 x 2 | 6/8 -> 7/8 after calibration | idempotence casing artifact fixed (metric -> canonical integer field); uc-03 cascade counting variance (quarterly_eval_entities 11 vs 12) is GENUINE Haiku floor-model variance on a 15-entity classify-and-count — kept for the N>=20 publication sweep to quantify, not calibrated away |
| 4 | 2026-06-11 | haiku-4.5 | pci 4 x 2 | **8/8 (100%)** | pci-dss-assessment calibration (M5 cycle 1): clean first-contact teachability — SAQ A-EP, 10/4 scope, six-row worksheet, idempotence all correct, zero contract-grammar fixes needed |
